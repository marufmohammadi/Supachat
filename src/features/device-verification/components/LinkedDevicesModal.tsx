    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/75 backdrop-blur-sm animate-fade-in">
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-6 text-left">
          ...
          <div>
            <h4 className="text-xs uppercase tracking-wider text-gray-400 font-bold mb-3 px-1">
              This Device
            </h4>
        ...
        <div className="fixed inset-0 z-60 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md animate-fade-in">
          <div className="w-full max-w-md bg-[#1f2c34] border border-[#2a3942] rounded-2xl p-5 space-y-4 shadow-2xl text-left">
            ...
            <p className="text-xs text-gray-300 leading-relaxed bg-[#111b21] p-3 rounded-xl border border-gray-800">
              This session will be terminated immediately. The device will no longer have access to active chats unless re-authenticated.
            </p>
